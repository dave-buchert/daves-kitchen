...
const QUOTES = [
  ...
  "I'm also just a girl, standing in front of a fridge, asking it to have something good. — Notting Hill",
  "To me, you are perfect. And my stomach agrees. — Love Actually",
  "You complete me... and so does this charcuterie board. — Jerry Maguire",
  "Frankly my dear, I don't give a clam. — Gone with the Wind",
  "I wish I knew how to quit you... but the leftovers are incredible. — Brokeback Mountain",
  "You talking to me? Because I made enough for everyone. — Taxi Driver",
  "I feel the need — the need to feed. — Top Gun: Maverick",
  "Keep the pasta, give back the cannoli. — The Godfather",
  "Leave the gun. Take the cannoli. — The Godfather",
  "You had me at 'I made reservations.' — Jerry Maguire",
  "Hasta la pizza, baby. — Terminator 2",
  "Wax on, wax off. Then wash the vegetables. — The Karate Kid",
  "To boldly cook what no one has cooked before. — Star Trek",
];
